  ...
  <div>
    ...
    >
          ...
          <Col span="12">
            <FormItem label="门脸照片" prop="door_face">
              ...
              <Upload
                ...
                type="drag"
                action="https://dc-api.warmsoft.com/api/services/app/FuYouService/PostUpload?fileTypeValue=6"
          ...
          <Col span="12">
            <FormItem label="门头照片" prop="door_head">
              ...
              <Upload
                ...
                type="drag"
                action="https://dc-api.warmsoft.com/api/services/app/FuYouService/PostUpload?fileTypeValue=7"
                style="display: inline-block; width: 58px"
              >
                <div style="width: 58px; height: 58px; line-height: 58px">
                  <Icon type="ios-camera" size="20"></Icon>
          ...
          <Col span="12">
            <FormItem label="法人身份证正面照片" prop="legalperson_positive">
              ...
              <Upload
                ...
                type="drag"
                action="https://dc-api.warmsoft.com/api/services/app/FuYouService/PostUpload?fileTypeValue=4"
                style="display: inline-block; width: 58px"
              >
                <div style="width: 58px; height: 58px; line-height: 58px">
                  <Icon type="ios-camera" size="20"></Icon>
          ...
          <Col span="12">
            <FormItem label="法人身份证反面照片" prop="legalperson_back">
              ...
              <Upload
                ...
                type="drag"
                action="https://dc-api.warmsoft.com/api/services/app/FuYouService/PostUpload?fileTypeValue=5"
                style="display: inline-block; width: 58px"
              >
                <div style="width: 58px; height: 58px; line-height: 58px">
                  <Icon type="ios-camera" size="20"></Icon>
        ...
        <Row>
          ...
          <Col span="12">
            <FormItem label="入账卡类型">
              <Select
                v-model="formValidate.acnt_type"
                style="width: 60%"
                disabled
              >
                <Option
        ...
        <Row>
          <Col span="12">
            <FormItem label="行别" prop="bank_type">
              <Select
                v-model="formValidate.bank_type"
                style="width: 60%"
                :label-in-value="true"
          ...
          <Col span="12">
            <FormItem label="入账卡开户行名称" prop="inter_bank_no">
              <Select
                v-model="formValidate.inter_bank_no"
                placeholder="请选择  如没有对应的支行，请选择地区内的支行，先提交"
                filterable
                clearable
                style="width: 60%"
                :label-in-value="true"
                @on-change="bankDictChange"
                not-found-text="请先选择商户经营地或行别"
              >
                <Option
      ...
      <FormItem>
        <Row>
          ...
          <Col span="12">
            <FormItem label="清算类型">
              <Select
                v-model="formValidate.settle_tp"
                disabled
                style="width: 60%"
              >
                <Option
      ...
      <FormItem>
        <Row>
          <Col span="12">
            <FormItem label="联系人身份证" prop="contact_cert_no">
              <Input
          ...
          <Col span="12">
            <FormItem label="法人身份证开始时间" prop="card_start_dt">
              <Input
                ...
                :maxlength="8"
                title="入账证件开始时间（格式例：2020年01月01日 输入20200101）"
                placeholder="入账证件开始时间（格式例：2020年01月01日 输入20200101）"
                style="width: 60%"
              ></Input>
            </FormItem>
          </Col>
          ...
          <Col span="12">
            <FormItem label="入账银行卡正面照片" prop="entry_bank_positive">
              ...
              <Upload
                ...
                type="drag"
                action="https://dc-api.warmsoft.com/api/services/app/FuYouService/PostUpload?fileTypeValue=12"
                style="display: inline-block; width: 58px"
              >
                <div style="width: 58px; height: 58px; line-height: 58px">
                  <Icon type="ios-camera" size="20"></Icon>
          ...
          <Col span="12">
            <FormItem label="手持证件照片" prop="hand_id">
              ...
              <Upload
                ...
                type="drag"
                action="https://dc-api.warmsoft.com/api/services/app/FuYouService/PostUpload?fileTypeValue=16"
                style="display: inline-block; width: 58px"
              >
                <div style="width: 58px; height: 58px; line-height: 58px">
                  <Icon type="ios-camera" size="20"></Icon>
...
export default class FuYou extends AbpBase {
  ...
  bankDictChange(info) {
    if (info != null) this.formValidate.iss_bank_nm = info.label
  }
  ...
  ruleValidate: any = {
    ...
    bank_type: [{ required: true, message: '请选择行别', trigger: 'change' }],
    acnt_no: [
      { required: true, message: '入账卡号不能为空', trigger: 'blur' },
      {
        type: 'string',
        min: 18,
        message: '入账卡号长度不能小于18',
        trigger: 'blur',
      },
    ],
    door_face: [
      {
        ...
        validator: (rule, value, cb) => {
          if (
            ...
            this.formValidate.door_face == null ||
            this.formValidate.door_face != value
          ) {
    ...
    door_head: [
      {
        ...
        validator: (rule, value, cb) => {
          if (
            ...
            this.formValidate.door_head == null ||
            this.formValidate.door_head != value
          ) {
    ...
    legalperson_positive: [
      {
        ...
        validator: (rule, value, cb) => {
          if (
            ...
            this.formValidate.legalperson_positive == null ||
            this.formValidate.legalperson_positive != value
          ) {
    ...
    legalperson_back: [
      {
        ...
        validator: (rule, value, cb) => {
          if (
            ...
            this.formValidate.legalperson_back == null ||
            this.formValidate.legalperson_back != value
          ) {
    ...
    entry_bank_positive: [
      {
        ...
        validator: (rule, value, cb) => {
          if (
            ...
            this.formValidate.entry_bank_positive == null ||
            this.formValidate.entry_bank_positive != value
          ) {
    ...
    hand_id: [
      {
        ...
        validator: (rule, value, cb) => {
          if (
            ...
            this.formValidate.hand_id == null ||
            this.formValidate.hand_id != value
          ) {
  ...
  getBankDictList() {
    this.bankDictList = []
    if (
      this.isNullOrEmpty(this.formValidate.bank_type) ||
      this.isNullOrEmpty(this.formValidate.city_cd)
    )
      return
    var requestParams = {
            ...
            this.$store
              ...
              .then((saveResponse) => {
                localStorage.setItem(
                  'trace_no',
                  saveResponse.data.result.trace_no
                )
